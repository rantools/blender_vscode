...
class BlenderExecutable {
    ...
    launch() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, utils_1.runTask)('blender', execution);
        });
    }
    launchDebug(folder) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    launchWithCustomArgs(taskName, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, utils_1.runTask)(taskName, execution, true);
        });
    }
}
...
function getBlenderLaunchArgs() {
    let config = (0, utils_1.getConfig)();
    return ['--python', paths_1.launchPath].concat(config.get("additionalArguments", []));
}
function getBlenderLaunchEnv() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return Object.assign({ REPO: config.get('addon.repoName'), UPDATEMANIFEST: config.get('addon.autoUpdateManifest') ? 'yes' : 'no', ADDONS_TO_LOAD: JSON.stringify(loadDirsWithNames), EDITOR_PORT: (0, communication_1.getServerPort)().toString(), ALLOW_MODIFY_EXTERNAL_PYTHON: config.get('allowModifyExternalPython') ? 'yes' : 'no' }, config.get("environmentVariables", {}));
    });
}
